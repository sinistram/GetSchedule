 ...
 */
public class AsyncUploadFileProcessTask extends AsyncTask<String, String, Boolean> {

    public AsyncUploadFileProcessTask(OcrResult activity) {
    ...
    /** application context. */
    private final OcrResult activity;
    ...
    protected Boolean doInBackground(String... args) {
        ...
        try {
            ...
            //TODO: language
            String language = "Russian"; // Comma-separated list: Japanese,English or German,French,Spanish etc.
